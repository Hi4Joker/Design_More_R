...
import mu.node.rexweather.app.Helpers.ModifyOffsetHelper;
import mu.node.rexweather.app.Helpers.PointDouble;
...
public class WeatherActivity extends Activity {
  ...
  public static class WeatherFragment extends Fragment {
    ...
    @Override public View onCreateView(final LayoutInflater inflater, final ViewGroup container,
      ...
      final WeatherForecastListAdapter adapter =
          new WeatherForecastListAdapter(new ArrayList<WeatherForecast>(), getActivity());
      ...
      mSwipeRefreshLayout =
          (SwipeRefreshLayout) rootView.findViewById(R.id.swipe_refresh_container);
      mSwipeRefreshLayout.setColorSchemeResources(R.color.brand_main, android.R.color.black,
          R.color.brand_main, android.R.color.black);
    ...
    private class WeatherForecastListAdapter extends ArrayAdapter {
      ...
      @Override public View getView(final int position, View convertView, final ViewGroup parent) {
        ...
        if (convertView == null) {
          ...
          viewHolder.maximumTemperatureTextView =
              (TextView) convertView.findViewById(R.id.maximum_temperature);
          viewHolder.minimumTemperatureTextView =
              (TextView) convertView.findViewById(R.id.minimum_temperature);
    ...
    private void updateWeather() {
      ...
      //final Observable<Location> observable = locationService.getLocation();
      // Get our current location.
      final Observable<HashMap<String, WeatherForecast>> fetchDataObservable =

          Observable.defer(new Func0<Observable<Location>>() {
            @Override public Observable<Location> call() {
              ...
              .flatMap(new Func1<Location, Observable<HashMap<String, WeatherForecast>>>() {
                ...
                public Observable<HashMap<String, WeatherForecast>> call(final Location location) {
                  ...
                  /*latitude = (Double.valueOf(lat) - 0.00555199) * 1E6 ;
                  longitude = (Double.valueOf(lng) - 0.006836000) * 1E6 ;*/

                  /*非官方的，火星坐标转换，精准度80%*/
                  /*PointDouble p = null;

                  try {
                    ModifyOffsetHelper modifyOffsetHelper = ModifyOffsetHelper.getInstance(
                        WeatherActivity.class.getResourceAsStream("axisoffset.dat"));

                    p = modifyOffsetHelper.s2c(
                        new PointDouble(location.getLatitude(), location.getLongitude()));
                  } catch (Exception e) {
                    e.printStackTrace();
                  }

                  final double latitude = p.y;
                  final double longitude = p.x;*/
                  /*http://openweathermap.org/img/w/10n.png*/
                  final double longitude = location.getLongitude();
                  final double latitude = location.getLatitude();

                  Log.e("Joker", "longitude:" + longitude + "\n latitude:" + latitude);
                  ...
                  return Observable.zip(
                      ...
                      new Func2<CurrentWeather, List<WeatherForecast>, HashMap<String, WeatherForecast>>() {
                        @Override public HashMap call(final CurrentWeather currentWeather,
      ...
      fetchDataObservable.flatMap(
          new Func1<HashMap<String, WeatherForecast>, Observable<String>>() {
            @Override public Observable<String> call(
                HashMap<String, WeatherForecast> stringWeatherForecastHashMap) {
              return null;
            }
      ...
      /*Observable.from(new ArrayList<Integer>()).subscribe(new Action1<Integer>() {
      ...
      fetchDataObservable.subscribe(mySubscriber);*/

      mCompositeSubscription.add(fetchDataObservable.subscribeOn(Schedulers.newThread())
          .observeOn(AndroidSchedulers.mainThread())
          .subscribe(new Subscriber<HashMap<String, WeatherForecast>>() {
            @Override public void onNext(final HashMap<String, WeatherForecast> weatherData) {
              // Update UI with current weather.
              final CurrentWeather currentWeather =
                  (CurrentWeather) weatherData.get(KEY_CURRENT_WEATHER);
              ...
              final List<WeatherForecast> weatherForecasts =
                  (List<WeatherForecast>) weatherData.get(KEY_WEATHER_FORECASTS);
              final WeatherForecastListAdapter adapter =
            ...
            @Override public void onError(final Throwable error) {
              ...
              if (error instanceof TimeoutException) {
                Crouton.makeText(getActivity(), R.string.error_location_unavailable, Style.ALERT)
                    .show();
