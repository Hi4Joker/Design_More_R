...
public class DialogPlus {
  ...
  /**
   * Determines the in and out animation of the dialog. Default animation are bottom sliding
   * animations
   */
  ...
  private DialogPlus(Builder builder) {
    ...
    backgroundColorResourceId =
        (backgroundColor == INVALID) ? android.R.color.white : backgroundColor;
    ...
    inAnimationResource =
        (inAnimation == INVALID) ? getAnimationResource(this.gravity, true) : inAnimation;
    outAnimationResource =
        (outAnimation == INVALID) ? getAnimationResource(this.gravity, false) : outAnimation;

    int minimumMargin =
        activity.getResources().getDimensionPixelSize(R.dimen.default_center_margin);
    ...
    rootView = (ViewGroup) inflater.inflate(R.layout.material_dialog_plus_root_layout, null);
  ...
  private void initContentView() {
    ...
    FrameLayout.LayoutParams params =
        new FrameLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT,
            ViewGroup.LayoutParams.WRAP_CONTENT, convertedGravity);
  ...
  public static class Builder {
    ...
    /**
     * Define if the dialog is cancelable and should be closed when back pressed or click outside
     * is
     * pressed
     */
    ...
    /**
     * Set an item click listener when list or grid holder is chosen. In that way you can have
     * callbacks when one
    ...
    /**
     * Set a global click listener to you dialog in order to handle all the possible click events.
     * You can then
