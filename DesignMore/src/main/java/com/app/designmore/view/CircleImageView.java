...
public class CircleImageView extends ImageView {
  ...
  public CircleImageView(Context context) {
    super(context);
    CircleImageView.this.initTypeArray(context, null);
    CircleImageView.this.init();
  }

  public CircleImageView(Context context, AttributeSet attrs) {
    super(context, attrs);
    CircleImageView.this.initTypeArray(context, attrs);
    CircleImageView.this.init();
  }
  ...
  private void initTypeArray(Context context, AttributeSet attrs) {
    ...
    try {
      mBorderWidth = typedArray.getDimensionPixelSize(R.styleable.CircleImageView_cir_border_width,
          DEFAULT_BORDER_WIDTH);
      mBorderColor =
          typedArray.getColor(R.styleable.CircleImageView_cir_border_color, DEFAULT_BORDER_COLOR);
      mBorderAlpha =
          typedArray.getInteger(R.styleable.CircleImageView_cir_border_alpha, DEFAULT_BORDER_ALPHA);
  ...
  private void setup() {
    ...
    CircleImageView.this.calculateMatrix(sourceBitmap);
