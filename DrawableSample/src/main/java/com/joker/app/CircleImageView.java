...
public class CircleImageView extends ImageView {
  ...
  public CircleImageView(Context context, AttributeSet attrs, int defStyle) {
    ...
    try {
      mBorderWidth = typedArray.getDimensionPixelSize(R.styleable.CircleImageView_border_width,
          DEFAULT_BORDER_WIDTH);
      mBorderColor =
          typedArray.getColor(R.styleable.CircleImageView_border_color, DEFAULT_BORDER_COLOR);
      mBorderOverlay =
          typedArray.getBoolean(R.styleable.CircleImageView_border_overlay, DEFAULT_BORDER_OVERLAY);
  ...
  private void setup() {
    ...
    Log.e(TAG, mDrawableRect.toString());
  ...
  @Override protected void onDraw(Canvas canvas) {
    ...
    Log.e(TAG, "canvas width:" + canvas.getWidth() + "canvas height:" + canvas.getHeight());
