 ...
 */
public class CameraBackActivity extends BaseActivity implements CameraHostProvider {

  private static final String TAG = CameraBackActivity.class.getCanonicalName();
  ...
  public static void navigateToCamera(AppCompatActivity startingActivity, boolean isAnim) {
    Intent intent = new Intent(startingActivity, CameraBackActivity.class);
  ...
  @Override protected void onCreate(Bundle savedInstanceState) {
    ...
    CameraBackActivity.this.initView(savedInstanceState);
  }
  ...
  @Override public void initView(Bundle savedInstanceState) {
    ...
    if (savedInstanceState == null && getIntent().getBooleanExtra(IS_ANIM, false)) {
      toolbar.getViewTreeObserver().addOnPreDrawListener(new ViewTreeObserver.OnPreDrawListener() {
        @Override public boolean onPreDraw() {
          toolbar.getViewTreeObserver().removeOnPreDrawListener(this);
          CameraBackActivity.this.startEnterAnim();
          return true;
        }
      });
    }
  ...
  @Override public boolean onCreateOptionsMenu(Menu menu) {
    ...
    switchActionButton.setOnClickListener(new View.OnClickListener() {
      @Override public void onClick(View v) {
        /*切换至前置摄像头*/
        CameraFrontActivity.navigateToCamera(CameraBackActivity.this);
    ...
    doneActionButton.setOnClickListener(new View.OnClickListener() {
      @Override public void onClick(View v) {
        if (EventBusInstance.getDefault().hasSubscriberForEvent(AvatarRefreshEvent.class)) {
          CameraBackActivity.this.saveBitmap();
        }
      }
    });
    return true;
  ...
  public void saveBitmap() {
    ...
    subscription = Observable.create(new Observable.OnSubscribe<File>() {
      @Override public void call(final Subscriber<? super File> subscriber) {
        ...
        threadSubscription = Schedulers.io().createWorker().schedule(new Action0() {
      ...
      @Override public void call() {
        ...
        if (progressDialog == null) {
          progressDialog = DialogManager.
              getInstance().showSimpleProgressDialog(CameraBackActivity.this, cancelListener);
        } else {
          progressDialog.show();
        }
      }
      ...
      @Override public void onError(Throwable e) {
        e.printStackTrace();
        Toast.makeText(CameraBackActivity.this, "保存失败，请重试", Toast.LENGTH_LONG).show();
      }
  ...
  @Override public CameraHost getCameraHost() {
    return new MyCameraHost(CameraBackActivity.this, false);
  }
  ...
  private void showTakenPicture(Bitmap bitmap) {
    ...
    /*拍摄 -> 展示*/
    CameraBackActivity.this.updateState(State.DISPLAY);
  }
