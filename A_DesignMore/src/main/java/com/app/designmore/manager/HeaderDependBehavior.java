 ...
 */
public class HeaderDependBehavior extends CoordinatorLayout.Behavior<MaterialRippleLayout> {

  private static final String TAG = HeaderDependBehavior.class.getCanonicalName();
  private float actionBarSize;

  public HeaderDependBehavior(Context context, AttributeSet attrs) {
    super(context, attrs);
