 ...
 */
public class ProductAttrAdapter extends RecyclerView.Adapter<ProductAttrAdapter.ViewHolder> {
  ...
  public ProductAttrAdapter(Context context, List<ProductAttrEntity> productAttrs) {
